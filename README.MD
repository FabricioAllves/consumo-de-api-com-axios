...
<p>
    ...
    Api tem como função basica de criar um game definindo title, year e price podendo editar, procurar por todos ou um id, deletar e listar.
...
```
Server started on port 2222! 🏆 GET http://localhost:3333
```
